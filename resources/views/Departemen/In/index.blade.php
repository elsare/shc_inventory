            ...
            <div class="col-md-12 col-sm-12">
                <div class="portlet box red">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-pencil"></i>Table Input</div>
                        <div class="actions">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="model" action="{{ route('Departemen.In.store') }}" method="POST" enctype="multipart" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="jumlah">Jumlah Input</label>
...
{!! JsValidator::formRequest('App\Http\Requests\Departemen\InRequest'); !!}
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var table = $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('Departemen.In.dataTable') }}",
            columns: [
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Departemen.In.destroy','') }}/${id}`,{
    ...
    function myFunction(id) {
      window.open(`{{ route('Departemen.In.show','') }}/${id}`);
    }
</script>
@endsection