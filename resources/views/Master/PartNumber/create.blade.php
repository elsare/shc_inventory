		       ...
		       <div class="portlet light">
	                <div class="portlet-title">
	                    <div class="caption font-dark">
	                        ...
	                        <span class="caption-subject bold uppercase">Create Part Number</span>
	                    </div>
	                </div>
                    <form action="{{ route('Master.PartNumber.store') }}" method="POST" enctype="multipart" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
							...
							<input type="text" class="form-control" id="part_no" name="part_no" placeholder="Input Part No." value="{{ old('part_no') }}">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="description" name="description" placeholder="Input Description" value="{{ old('description') }}">
