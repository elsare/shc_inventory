		...
		<div class="row">
		    <div class="col-md-12">
			    <div class="portlet light">
                    ...
                    <strong style="font-size:25px;padding-left: 350px;">LAPORAN BARANG KELUAR</strong>
                    <hr>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTable dtr-inline" id="datatable" role="grid">
                                ...
                                <tbody>
                                	...
                                	<tr>
                                		...
                                		<td>
                                			<button class="btn btn-sm green" data-id="{{ $jml->jumlah_output_id }}" data-toggle="tooltip" title="PRINT" id="jml_id">
...
<script type="text/javascript">
    ...
    $('body').on('click', '#jml_id', function(){
     ...
     window.open(`{{ route('Transaksi.Output.print','') }}/${jml_id}`);
