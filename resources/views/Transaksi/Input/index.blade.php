                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                <span class="caption-subject bold uppercase">Input</span>
                            </div>
                            <div class="actions">
...
<script>
    ...
    $(document).ready(function(){
        var table = $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('Transaksi.Input.dataTable') }}",
            columns: [
    ...
    const deleteData = async (id) => {
           const res = await fetch(`{{ route('Transaksi.Input.destroy','') }}/${id}`,{
    ...
    function myFunction(id) {
      window.open(`{{ route('Transaksi.Input.show','') }}/${id}`);
    }
</script>
@endsection
